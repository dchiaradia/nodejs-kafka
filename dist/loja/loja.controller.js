...
const loja_services_1 = require("./loja.services");
let LojaController = class LojaController {
    constructor() {
        this.lojaService = new loja_services_1.LojaService();
    }
    produzKafka(msg) {
        const msgProduzida = this.lojaService.produzKafka(msg);
        return msgProduzida;
    }
};
__decorate([
...
], LojaController.prototype, "produzKafka", null);
